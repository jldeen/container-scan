...
function runTrivy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log("Scanning for vulnerabilties on image: " + imageName);
...
function getSummary(trivyStatus) {
    ...
    switch (trivyStatus) {
        ...
        case exports.TRIVY_EXIT_CODE:
            ...
            break;
        default:
            summary = 'An error occurred while scanning container image: ' + imageName + ' for vulnerabilities. Please check your image name and try again.';
            break;
    }
    return `- ${summary}`;
}
